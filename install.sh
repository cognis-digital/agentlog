#!/usr/bin/env sh
# Universal installer for agentlog. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/agentlog.git"
echo "Installing agentlog ..."
