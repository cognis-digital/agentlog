"""Native cognis-connect emit for agentlog — forward findings to any platform.

Maps agentlog's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    agentlog ... --format json | agentlog-emit --to stix
    agentlog-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
